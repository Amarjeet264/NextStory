                ...
                <div className="flex flex-wrap justify-between items-center space-y-6 md:space-y-0">
                    <div className="flex items-center space-x-4">
                        ...
                        <p className="text-base text-gray-100">
                            Designed and Developed by Amarjeet Singh<br />&copy; Copyright 2023-24 | All Rights Reserved
                        </p>
                    </div>
                    <div className="flex space-x-4">
                        <a href="https://www.instagram.com/_amarjeetyadav?igsh=d3Q5cWRmeG42aGRr" className="text-indigo-400 hover:text-indigo-300">
                        ...
                        <a href="https://www.linkedin.com/in/amarjeet-singh-4aa218232" className="text-indigo-400 hover:text-indigo-300">
                        ...
                        <a href="https://github.com/Amarjeet264" className="text-indigo-400 hover:text-indigo-300">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32">
